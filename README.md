...
This repository contains code to reproduce the neural feedback loop analysis experiment (Section V.A) from our paper on convex hull reachability analysis under disturbances (T. Lew, R. Bonalli, M. Pavone, ["Exact characterization of the convex hulls of reachable sets"](https://arxiv.org/abs/2303.17674v2), 2023).
